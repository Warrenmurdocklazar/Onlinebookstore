...
#import sqlite3 to make database for books
...
#add data into table using execute many
...
while user_input != "Exit":
 ...
 user_input = input("Hello, please enter one of the following functions: View Books/Enter book/Update book/Delete book/Search books/Exit: ")
...
#update book function, confirming user input and display user information in friendly manner
   ...
   if choice == 'id':
    ...
    while id != int:
     try:
      id = int(input("Please enter id of new book: "))
      break
     except ValueError:
      print("Please only enter an integer number")
...
#delete book function asking user to confirm deletion
  ...
  while id != int:
   ...
   choice = input(
    f"Are you sure you want to delete book:{book} with id:{id}. Enter 'Y' to delete or 'N' to return to menu")
   choice = choice.lower()
